...
/// <summary>
/// Manifest URL nhÃºng trong exe (obfuscate) â€” khÃ´ng ship plain text trong zip.
/// Regenerate payload khi publish: scripts/embed-update-endpoint.ps1
/// </summary>
internal static class UpdateEndpointStore
{
    // Replaced by publish.ps1 â€” do not edit payload by hand.
    ...
    /// <summary>Chá»‰ dÃ¹ng khi cháº¡y tá»« source/debug â€” file khÃ´ng Ä‘Ã³ng gÃ³i trong zip release.</summary>
