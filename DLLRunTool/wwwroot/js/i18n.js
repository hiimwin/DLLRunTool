  ...
  const MESSAGES = {
    vi: {
      ...
      global: {
        ...
        subtitleBe: "SelfUrl/host → appsettings.json; connection string → appsettings.secrets.json (không commit)",
        ...
        http: "Kết nối HTTP",
        database: "Database",
        dbHint: "Ghi vào appsettings.secrets.json (mọi service BE) — không ghi vào appsettings.json",
    ...
    en: {
      ...
      global: {
        ...
        subtitleBe: "SelfUrl/host → appsettings.json; connection string → appsettings.secrets.json (do not commit)",
        ...
        database: "Database",
        dbHint: "Written to appsettings.secrets.json (all BE) — not appsettings.json",
        connString: "Connection string",
