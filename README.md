...
```powershell
.\scripts\release-full.ps1 -Version "1.2.8" -ReleaseNotes "Mo ta thay doi"
```

Hoặc từng bước:

```powershell
.\publish.ps1 -Version "1.2.8" `
  -DownloadUrl "https://github.com/hiimwin/DLLRunTool/releases/download/v1.2.8/Win_Trung-MicroservicesControlPanel.zip" `
  -ReleaseNotes "Mo ta thay doi"
.\create-release.ps1 -Version "1.2.8"
```
